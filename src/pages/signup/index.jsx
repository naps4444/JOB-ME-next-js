      ...
      <div className=' w-10/12 md:w-9/12 lg:w-10/12 xl:w-8/12 mx-auto mt-5 my-auto'>
        ...
        <Image src="/jobme.png" width={75} height={75} alt='home logo' />
          ...
          <form className=' flex flex-col mt-7 gap-6'>
            ...
            <input type="text" placeholder='First name' className='w-full p-2 rounded-lg bg-transparent outline-none' />
            </div>

            <div className='w-full border rounded-lg bg-transparent'>
            <input type="text" placeholder='Last name' className='w-full p-2 rounded-lg bg-transparent outline-none' />
            </div>
            ...
            <div className='w-full border rounded-lg bg-transparent'>
            <input type="password" placeholder='Confirm password' className='w-full p-2 rounded-lg bg-transparent outline-none' />
            </div>
